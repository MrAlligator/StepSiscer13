        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="optimasi" action="<?= base_url('genetik/optimasi') ?>">
                            <div class="row">
                                <!-- <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="jumlah_populasi" name="jumlah_populasi" min=1 max=<?= count($supplier); ?> class="form-control" value="Jumlah Populasi">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="mutasi" name="mutasi" class="form-control" step="0.1" min=0.0 max=1.0>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
